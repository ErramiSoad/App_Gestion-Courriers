                                        ...
                                        <table class="table table-hover" id="TblData" data-toggle="table" data-target="table" data-sortable="true">
                                            ...
                                            <tbody>
                                                        <?php
                                                            ...
                                                            $sql="SELECT DISTINCT (c.numero) ,msg.courrier_id ,c.arrive_le ,c.exp_numero ,c.exp_date ,c.objet , E.libel_etablis  FROM courriers c , courriers_destinations d, courriers_etablissements E ,courriers_supports s, courriers_msg msg
