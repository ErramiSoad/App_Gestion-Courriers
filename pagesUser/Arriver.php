                        ...
                        <table class="table table-hover" id="table" data-toggle="table" data-target="table" data-sortable="true">
                            ...
                            <tbody>
                                    <?php
                                        ...
                                        $sql="SELECT Distinct(c.numero) ,c.type_courrier ,c.arrive_le ,c.exp_numero ,c.exp_date ,c.objet, c.chemin, d.exp_etablis, d.courrier_id, E.libel_etablis FROM courriers c , courriers_destinations d, courriers_etablissements E,courriers_msg msg 
                                        WHERE c.id=d.courrier_id 
                                        AND E.id=d.exp_etablis
                                        AND c.id=msg.courrier_id
                                        AND msg.destination_msg=$idUser
