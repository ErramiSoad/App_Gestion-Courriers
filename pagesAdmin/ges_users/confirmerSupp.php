        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li class="active"><a href="Profile.php"><i class="material-icons">person</i>Profile</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="ModifierPass/ChangePass.php" >
        ...
        <div class="row clearfix">
            ...
            <div class="panel panel-default">
                    <div class="panel-heading">
                       Voulez vous vraiment supprimer ce utilisateur  de façon permanente ?
                    </div>
                    <div class="panel-body container">
                      <a href="supprimer.php?deleteid=<?=$id = $_GET["deleteid"];?>" type="button" class="btn btn-primary btn-g" >oui</a>
                      <a href="../Profile.php" type="button"  class="btn btn-primary btn-g">non</a>
                   </div>
                </div>
            </div>
        </div>
