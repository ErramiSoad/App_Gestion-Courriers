...
if(isset($_POST['submit'])){
    ...
    if($result){ 
        $sqll="insert into `courriers_msg`( courrier_id, expediteur_msg, destination_msg, type_msg, envoie_date, observ_msg ) values ( '$courrier_id', '$idExp', '$idTrans[0]', 'T', NOW(),'observ')";
