        ...
        <div class="row clearfix">
            ...
            <div class="panel panel-default">
                    ...
                    <div class="panel-body container">
                      <a href="./supprimerCA.php?deleteid=<?=$id = $_GET["deleteid"];?>" type="button" class="btn btn-primary btn-g" >oui</a>
                      <a href="../Arriver.php" type="button"  class="btn btn-primary btn-g">non</a>
                   </div>
                </div>
            </div>
        </div>
