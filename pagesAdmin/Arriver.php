                                                ...
                                                $date=explode("-",$arrive);
                                                    ...
                                                    echo '
                                                        <tr class="table-active">
                                                            ...
                                                            <td>
                                                                <a style="color:#008080" href="ges_courriers/ModifierCourrierA.php?updateid='.$id.'" class="edit" title="Edit" ><i class="material-icons">&#xE254;</i></a>
                                                            </td>
                                                            <td>
                                                                <a style="color:#008080"  href="ges_courriers/ConfirmSuppA.php?deleteid='.$id.'" title="Delete"><i class="material-icons">&#xE872;</i></a>
                                                            </td>
                                                        <th scope="row">'.$id.'</th>
                                                            <td>'.$arrive.'</td>
                                                            <td>'.$expN.'</td>
