                                                ...
                                                // else $icon='<a style="color:#008080" ><i class="material-icons">drafts</i></a>';
                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a style="color:#008080" href="ges_courriers/ModifierCourrierD.php?updateid='.$id.'" class="edit" title="Edit" ><i class="material-icons">&#xE254;</i></a>
                                                            </td>
                                                            <td>
                                                                <a style="color:#008080"  href="ges_courriers/ConfirmSuppD.php?deleteid='.$id.'" title="Delete"><i class="material-icons">&#xE872;</i></a>
                                                            </td>
